import AnabelianReconstructionProgramCanonicalLaneLean.FinalTheorem
...
Anabelian Reconstruction Program endgame pilot. The pilot closes over its admitted class and carries the
