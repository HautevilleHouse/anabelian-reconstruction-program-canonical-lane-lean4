# Anabelian Reconstruction Program — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/anabelian-reconstruction-program-canonical-lane-mathlib.git
cd anabelian-reconstruction-program-canonical-lane-mathlib
lake exe
lake build
```
